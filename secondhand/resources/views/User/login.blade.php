    ...
    @endif
        ...
        <form class="form" action="" method="POST">
          @csrf
           ...
           <div style="margin-top: 1rem;" class="d-flex">
            <a class="flex-fill" href="{{ route('password.request') }}">Forgot password</a>
           <div class="flex-fill">
            <span style="font-size: 1.1rem; font-weight: 400; margin: 1rem;">Do not have an account?
            </span>
